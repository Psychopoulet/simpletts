        ...
        return new Promise((resolve, reject) => {
            (0, node_child_process_1.exec)(IS_SAPI ?
                ...
                if (err) {
                    ...
                    if (IS_SAPI) {
                        resolve((0, parseVoicesSAPI_1.default)(stdout.slice(1, stdout.length), stdout).map((voice) => {
                            return {
                        ...
                        resolve((0, parseVoicesEspeak_1.default)(stdout.slice(1, stdout.length)).map((voice) => {
                            return {
